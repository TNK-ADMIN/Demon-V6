...
if (command === 'help') {
  ...
  const response = new Discord.RichEmbed()
    .setColor("#8b1e9b")
    .setAuthor(`Welcome to the new version of Khask39#4073`,"","https://t.me/fuck")
    .setTitle(":flag_br: - Khask39#4073 - Help Menu - :flag_br:")
    .setDescription("ĐỊT MẸ MẤY THẰNG KID .")
...
if (command === 'buy') {
  ...
  const privbuyembed = new Discord.RichEmbed()
    ...
    .setColor('#ff0000')
    .setTitle(':flag_br: - Khask39#4073 - Buy Menu - :flag_br:')
...
const methodsem = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle(":flag_br: - Khask39#4073 - Methods DDoS - :flag_br:")
